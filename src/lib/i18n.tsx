...
const id: Dictionary = {
  ...
  hero_badge: '🤖 Powered by AI — Gratis untuk Semua',
  ...
  hero_trust_badge: '🔒 Privasi Terjaga — Kontrak Anda Tidak Disimpan',
  ...
  testimonials_subtitle: 'Testimoni',
  testimonials_title: 'Cerita Pengguna',
  testimonials_desc: 'Bagaimana KawalKontrak.ai membantu pekerja Indonesia.',
  ...
  footer_legal: 'Legal',
  footer_disclaimer: '⚠️ KawalKontrak.ai bukan nasihat hukum. Hasil analisis bersifat edukatif. Konsultasikan dengan profesional hukum untuk kasus yang memerlukan penanganan serius.',
  footer_copyright: '© 2024 KawalKontrak.ai — Dibuat dengan ❤️ untuk Pekerja Indonesia',
  ...
  analysis_copy_email: '✉️ Salin Template Email',
...
const en: Dictionary = {
  ...
  hero_badge: '🤖 Powered by AI — Free for Everyone',
  ...
  hero_trust_badge: '🔒 Privacy Protected — Your Contract Is Not Stored',
  ...
  testimonials_desc: 'How KawalKontrak.ai helps Indonesian workers.',
  ...
  footer_legal: 'Legal',
  footer_disclaimer: '⚠️ KawalKontrak.ai is not legal advice. Analysis results are educational. Consult a legal professional for cases requiring serious attention.',
  footer_copyright: '© 2024 KawalKontrak.ai — Made with ❤️ for Indonesian Workers',
  ...
  analysis_copy_email: '✉️ Copy Email Template',
