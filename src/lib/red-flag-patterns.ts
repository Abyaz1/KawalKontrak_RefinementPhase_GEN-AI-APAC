...
[Nama Anda]`,
  ...
  // =========================================================================
  {
    ...
    keywords: [
      ...
      'lembur sesuai kebijakan',
      'sudah termasuk lembur',
...
[Nama Anda]`,
  ...
  // =========================================================================
  {
    ...
    keywords: [
      'lebih dari 5 tahun',
      'perpanjangan tanpa batas',
      'dapat diperpanjang terus',
...
[Nama Anda]`,
  ...
  // =========================================================================
  {
    ...
    keywords: [
      ...
      'tidak menanggung bpjs',
      'bpjs ditanggung pekerja',
...
[Nama Anda]`,
  ...
  // =========================================================================
  {
    ...
    keywords: [
      ...
      'selamanya rahasia',
      'rahasia selamanya',
      'kerahasiaan seumur hidup',
      'tanpa batas waktu kerahasiaan',
      'segala informasi bersifat rahasia',
    ],
    description:
...
[Nama Anda]`,
  ...
  // =========================================================================
  {
    ...
    keywords: [
      ...
      'tanpa surat pengangkatan',
      'kontrak lisan',
      'perjanjian lisan',
      'kesepakatan lisan',
      'tidak memerlukan perjanjian tertulis',
    ],
    description:
